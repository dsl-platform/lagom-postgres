...
"ORDER BY 1, 2, 6");
        ...
        worldwonders.storage.converters.ImageCacheConverter storage$converter$ImageCacheConverter = new worldwonders.storage.converters.ImageCacheConverter(columns);
        container.registerInstance(worldwonders.storage.converters.ImageCacheConverter.class, storage$converter$ImageCacheConverter, false);
        container.registerInstance(new org.revenj.patterns.Generic<org.revenj.postgres.ObjectConverter<worldwonders.storage.ImageCache>>(){}.type, storage$converter$ImageCacheConverter, false);
        storage$converter$ImageCacheConverter.configure(container);
        metamodel.registerDataSource(worldwonders.storage.ImageCache.class, "\"storage\".\"ImageCache_entity\"");
        metamodel.registerProperty(worldwonders.storage.ImageCache.class, "getURI", "\"URI\"", worldwonders.storage.ImageCache::getURI);

        container.register(worldwonders.storage.repositories.ImageCacheRepository.class);
        container.registerFactory(new org.revenj.patterns.Generic<org.revenj.patterns.SearchableRepository<worldwonders.storage.ImageCache>>(){}.type, worldwonders.storage.repositories.ImageCacheRepository::new, false);

        container.registerFactory(new org.revenj.patterns.Generic<org.revenj.patterns.Repository<worldwonders.storage.ImageCache>>(){}.type, worldwonders.storage.repositories.ImageCacheRepository::new, false);
        container.registerFactory(new org.revenj.patterns.Generic<org.revenj.postgres.BulkRepository<worldwonders.storage.ImageCache>>(){}.type, worldwonders.storage.repositories.ImageCacheRepository::new, false);
        metamodel.registerProperty(worldwonders.storage.ImageCache.class, "getUrl", "\"url\"", worldwonders.storage.ImageCache::getUrl);
        metamodel.registerProperty(worldwonders.storage.ImageCache.class, "getSize", "\"size\"", worldwonders.storage.ImageCache::getSize);
        metamodel.registerProperty(worldwonders.storage.ImageCache.class, "getBody", "\"body\"", worldwonders.storage.ImageCache::getBody);
        metamodel.registerProperty(worldwonders.storage.ImageCache.class, "getWidth", "\"width\"", worldwonders.storage.ImageCache::getWidth);
        metamodel.registerProperty(worldwonders.storage.ImageCache.class, "getHeight", "\"height\"", worldwonders.storage.ImageCache::getHeight);
        metamodel.registerProperty(worldwonders.storage.ImageCache.class, "getCreatedAt", "\"createdAt\"", worldwonders.storage.ImageCache::getCreatedAt);

        container.registerFactory(new org.revenj.patterns.Generic<org.revenj.patterns.PersistableRepository<worldwonders.storage.ImageCache>>(){}.type, worldwonders.storage.repositories.ImageCacheRepository::new, false);
    }
}
