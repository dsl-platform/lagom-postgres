...
"ORDER BY 1, 2, 6");
        ...
        worldwonders.comments.converters.CommentConverter comments$converter$CommentConverter = new worldwonders.comments.converters.CommentConverter(columns);
        container.registerInstance(worldwonders.comments.converters.CommentConverter.class, comments$converter$CommentConverter, false);
        container.registerInstance(new org.revenj.patterns.Generic<org.revenj.postgres.ObjectConverter<worldwonders.comments.Comment>>(){}.type, comments$converter$CommentConverter, false);
        comments$converter$CommentConverter.configure(container);
        metamodel.registerDataSource(worldwonders.comments.Comment.class, "\"comments\".\"Comment_event\"");
        metamodel.registerProperty(worldwonders.comments.Comment.class, "getURI", "\"URI\"", worldwonders.comments.Comment::getURI);
        metamodel.registerProperty(worldwonders.comments.Comment.class, "getQueuedAt", "\"QueuedAt\"", worldwonders.comments.Comment::getQueuedAt);
        metamodel.registerProperty(worldwonders.comments.Comment.class, "getProcessedAt", "\"ProcessedAt\"", worldwonders.comments.Comment::getProcessedAt);

        container.register(worldwonders.comments.repositories.CommentRepository.class);
        container.registerFactory(new org.revenj.patterns.Generic<org.revenj.patterns.SearchableRepository<worldwonders.comments.Comment>>(){}.type, worldwonders.comments.repositories.CommentRepository::new, false);

        container.registerFactory(new org.revenj.patterns.Generic<org.revenj.patterns.Repository<worldwonders.comments.Comment>>(){}.type, worldwonders.comments.repositories.CommentRepository::new, false);
        container.registerFactory(new org.revenj.patterns.Generic<org.revenj.postgres.BulkRepository<worldwonders.comments.Comment>>(){}.type, worldwonders.comments.repositories.CommentRepository::new, false);
        container.registerFactory(new org.revenj.patterns.Generic<org.revenj.patterns.DomainEventStore<worldwonders.comments.Comment>>(){}.type, worldwonders.comments.repositories.CommentRepository::new, false);
        try {
            org.revenj.Revenj.registerEvents(container, plugins, worldwonders.comments.Comment.class, worldwonders.comments.Comment[].class);
        } catch (java.lang.Exception e) {
            throw new java.io.IOException(e);
        }
        metamodel.registerProperty(worldwonders.comments.Comment.class, "getTopic", "\"topic\"", worldwonders.comments.Comment::getTopic);
        metamodel.registerProperty(worldwonders.comments.Comment.class, "getUser", "\"user\"", worldwonders.comments.Comment::getUser);
        metamodel.registerProperty(worldwonders.comments.Comment.class, "getTitle", "\"title\"", worldwonders.comments.Comment::getTitle);
        metamodel.registerProperty(worldwonders.comments.Comment.class, "getBody", "\"body\"", worldwonders.comments.Comment::getBody);
        metamodel.registerProperty(worldwonders.comments.Comment.class, "getRating", "\"rating\"", worldwonders.comments.Comment::getRating);
        metamodel.registerSpecification(worldwonders.comments.Comment.findByTopic.class, worldwonders.comments.Comment.findByTopic::rewriteLambda);
    }
}
